...
sensor sensors[] = {
  {A15, 2, 2, "IAT", "IAT", 20.3, 0, 0, 0, false, 1000, 0, 0, 0, 0},
  {A11, 5, 1, "EGT", "EGT", 343, 0, 0, 0, false, 0, 0, 0, 0, 0},
  {A13, 1, 1, "BOOST", "Boost", 0.32, 2, 0, 0, true, 0, 10, 0, 0, 0},
  {A9, 3, 3, "FPRESS", "Fuel P", 4.1, 1, 0, 0, false, 0, 5, 0, 0, 0},
  // {A6, 3, 3, "ATPRESS", "AT Press", 4.1, 1, 0, 0, false, 0, 0},
  // {A6, 3, 3, "ATTEMP", "AT Temp", 42.3, 0, 0, 0, false, 0, 0},
  {40, 4, 3, "CTEMP", "C Temp", 1, 0, 0, 0, false, 0, 0, 0, 0, 0},
  {0, 7, 1, "INJ", "Inj", 10, 0, 0, 0, false, 0, 5, 0, 0, 0},
  {1, 6, 2, "SPD", "Spd", 10, 0, 0, 0, false, 0, 5, 0, 0, 0},
  {0, 8, 3, "DTY", "Duty", 1, 0, 0, 0, false, 0, 0, 0, 0, 0},
  {0, 9, 3, "DST", "Dist", 1, 2, 0, 0, false, 0, 0, 0, 0, 0},
};
